  ...
  return (
    <section>
      <div className="relative flex items-center justify-center">
        <Image
          src={theme === "dark" ? dark_polygon_star : polygon_star}
          alt="polygon"
        ...
        />
        <Image
          src={theme === "light" ? with_glass : black_img}
          alt="classic"
          onClick={() =>
      ...
      <div className="w-full px-12   flex flex-col mx-auto space-y-1 items-center  justify-center">
        <section id="about" className="px-5   space-y-1">
          ...
          <blockquote className="relative flex flex-col items-center">
            <svg
              className="absolute -top-6 -start-8 h-16 w-16 text-gray-300 dark:text-gray-700"
              width="16"
              height="16"
              viewBox="0 0 16 16"
              fill="none"
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <Image
                    ...
                    src={
                      theme === "dark" ? profile_old_black : profile_old_light
                    }
                    alt="onesamket"
                  />
                </div>
                <div className="ms-4">
                  ...
                  <Link
                    ...
                    className="text-xs flex  text-gray-500 hover:text-indigo-700"
                  >
