...
const patternStyles = {
  ...
  lines: 'bg-[repeating-linear-gradient(45deg,#e5e7eb_0px,#e5e7eb_1px,transparent_1px,transparent_10px)] dark:bg-[repeating-linear-gradient(45deg,#1f1f21_0px,#1f1f21_1px,transparent_1px,transparent_10px)]',
  none: ''
};
...
export const Container = forwardRef<HTMLDivElement, ContainerProps>(({
  ...
  const baseStyles = cn(
    ...
    // Glass effect
    glass && 'backdrop-blur-sm bg-white/80 dark:bg-[#01040f]/80 border border-white/20 dark:border-white/10',

    // Animation
    animated && 'hover:scale-[1.01] hover:shadow-lg transition-transform duration-300',
  ...
  return (
    ...
    >
      ...
      {glass && (
        <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent dark:from-white/5 pointer-events-none rounded-inherit" />
      )}
