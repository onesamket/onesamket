      ...
      <div className="w-full max-w-2xl mx-auto text-center">
        ...
        >
          <div className="relative flex items-center justify-center">
            {/* Outer Ring */}
            <motion.div
              className="absolute h-24 w-24 sm:h-32 sm:w-32 rounded-full border-2 border-primary/20"
              animate={{ rotate: 360 }}
            ...
            {/* Middle Ring */}
            <motion.div
              className="absolute h-20 w-20 sm:h-28 sm:w-28 rounded-full border-2 border-primary/40"
              animate={{ rotate: -360 }}
            ...
            {/* Inner Ring */}
            <motion.div
              className="absolute h-16 w-16 sm:h-24 sm:w-24 rounded-full border-2 border-primary/60"
              animate={{ rotate: 360 }}
            ...
            <motion.div
              className="relative h-16 w-16 sm:h-20 sm:w-20 overflow-hidden rounded-full border-2 sm:border-4 border-primary/30 bg-gradient-to-br from-primary/10 to-primary/5 backdrop-blur-sm"
              animate={{
                scale: [1, 1.05, 1],
                boxShadow: [
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <h2 className={`text-base sm:text-lg font-medium ${currentMessage.color} leading-relaxed`}>
              {currentMessage.text}
            </h2>
          </motion.div>
        </AnimatePresence>
        ...
        >
          {[0, 1, 2].map((index) => (
            <motion.div
              key={index}
              className="h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-primary/60"
              animate={{
                scale: [1, 1.5, 1],
                opacity: [0.5, 1, 0.5]
              }}
