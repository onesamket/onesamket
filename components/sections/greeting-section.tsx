...
export default function GreetingSection() {
  ...
  return (
    <section className="relative flex h-full flex-col items-center justify-center px-4 py-20 lg:min-h-[90vh]">
      {/* Background gradient */}
      ...
      <div className="mb-8 max-w-3xl text-center text-xl text-gray-700 dark:text-gray-300 md:text-2xl">
        <h2 className="font-light">
          Full-stack Software Developer <br /> Website, Desktop & React Native
          Developer.
          {toGeez(7)}{' '}
        </h2>
      </div>
      ...
      {/* Scroll indicator */}
      <button
        className="absolute bottom-8 left-1/2 hidden -translate-x-1/2 transform cursor-pointer rounded-full p-2 transition-transform duration-200 hover:scale-110 focus:scale-110 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 lg:block"
        onClick={scrollToNextSection}
        onKeyDown={handleKeyDown}
        title="Scroll to next section"
        aria-label="Scroll to skills section"
      >
        <div className="flex h-10 w-6 justify-center rounded-full border-2 border-gray-400 pt-2 transition-colors duration-200 hover:border-gray-600 dark:border-gray-600 dark:hover:border-gray-400">
