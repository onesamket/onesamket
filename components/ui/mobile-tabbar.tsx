...
export function MobileTabbar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
      <div className="bg-background/80 backdrop-blur-lg border-t border-border px-2 py-1 flex justify-around items-center">
        {tabs.map((tab) => (
          <TabButton
            key={tab.name}
            tab={tab}
...
function TabButton({ 
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        "relative flex flex-col items-center justify-center w-16 h-14 rounded-lg transition-colors",
