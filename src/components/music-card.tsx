...
const MusicCard: React.FC = () => {
  return (
    <div className="bg-white dark:bg-brand-darkCard rounded-[32px] p-6 shadow-sm border border-gray-100 dark:border-white/5 h-full relative overflow-hidden group transition-colors duration-300">
      <div className="flex justify-between items-start mb-4 z-10 relative">
        <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">On Repeat</h3>
        <Music2 className="w-4 h-4 text-brand-orange/50" />
      </div>
      ...
      <div className="mt-8 text-center z-10 relative">
        <h4 className="font-bold text-brand-black dark:text-white text-lg transition-colors truncate">Habesha Classics</h4>
        <p className="text-xs text-brand-textGray mt-1">Teddy, Aster & Tewodros</p>
      </div>
